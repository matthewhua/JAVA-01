...
import io.matthew.rpcfx.api.RpcfxResponse;
import io.matthew.rpcfx.api.ServiceProviderDesc;
import io.matthew.rpcfx.demo.api.OrderService;
import io.matthew.rpcfx.demo.api.UserService;
import io.matthew.rpcfx.server.RpcfxInvoker;
...
public class RpcfxServerApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		CuratorFramework client = CuratorFrameworkFactory.builder().connectString("localhost:2181").namespace("rpcMatt").retryPolicy(retryPolicy).build();
		client.start();


		String userService = "io.matthew.rpcfx.demo.api.UserService";
		registerService(client, userService);
		String orderService = "io.matthew.rpcfx.demo.api.OrderService";
	...
	@Autowired RpcfxInvoker invoker;
	...
	@Bean(name = "io.matthew.rpcfx.demo.api.UserService")
	public UserService createUserService(){
		return new UserServiceImpl();
	}

	@Bean(name = "io.matthew.rpcfx.demo.api.OrderService")
