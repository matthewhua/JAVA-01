...
public class JDBCUtils {
    ...
    static {
        ...
        config.setJdbcUrl("jdbc:mysql://localhost:3306/geektime?characterEncoding=utf-8"); //数据源
    ...
    public static Connection getConnection(Boolean useHikari) throws ClassNotFoundException, SQLException {
        ...
        // 通过驱动管理类获取数据库链接
        return DriverManager.getConnection("jdbc:mysql://localhost:3306/geektime?characterEncoding=utf-8", "root", "123456");
    }
