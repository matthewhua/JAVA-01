...
public class ReentrantReadWriteLockDemo2 {
    ...
    public static void main(String[] args) {
        ReentrantReadWriteLockDemo2 lockDemo2 = new ReentrantReadWriteLockDemo2();
        lockDemo2.readWrite("Java Concurrency ");
    }
}
